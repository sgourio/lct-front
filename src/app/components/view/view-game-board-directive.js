...
angular.module('lct')
  .directive('viewGameBoard', ['$log', 'gameService', '$state', '$auth', 'gameBoardService', 'playGameService', 'messageService', function($log, gameService, $state, $auth, gameBoardService, playGameService, messageService) {
    return {
      restrict: 'E',
      scope: {
        round:'='
